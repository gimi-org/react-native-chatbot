...
import {Button, View, Dimensions, TextInput, ScrollView, Platform, KeyboardAvoidingView } from 'react-native'
...
class ChatBot extends Component {
  ...
  onContentSizeChange(contentWidth, contentHeight) {
    if (!!this.scrollView && !!this.scrollView.scrollToEnd) this.scrollView.scrollToEnd();
  }
  ...
  footerStyle = () => ({borderColor: props.disabled && !props.invalid ? '#ddd' : props.invalid ? '#E53935' : props.color})
  ...
  render() {
    ...
    let {backgroundComponent} = this.props
    return (
      ...
      {backgroundComponent}
        ...
        <KeyboardAvoidingView behavior={platformBehavior}>
          <View style={[this.footerStyle(), styles.footer, footerStyle]} />
